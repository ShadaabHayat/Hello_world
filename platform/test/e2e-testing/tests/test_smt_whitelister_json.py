...
def test_smt_whitelister_json():
    whitelister_template(
        record_count=10
    )

def whitelister_template(record_count, schema_type="json"):
    schema_suffix = ".json"
    ...
    expected_fields = ["id", "num1", "nest1", "__op", "__deleted", "rdc", "env", "last_modified_at"]
